...
import br.edu.ifpb.padroes.servico.AdministradorService;
...
public class TelaPesquisaAdmin extends javax.swing.JFrame {

    public TelaPesquisaAdmin() throws ParseException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel5.setText("PESQUISAR - ADMINISTRADOR");
    ...
    private void pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisarActionPerformed
        ...
        try {
            ...
            administrador = administradorService.pesquisarAdministrador(this.cpf.getText());

            if (administrador == null) {
                JOptionPane.showMessageDialog(null, "Nenhum administrador encontrado !");
            } else {
                this.cpf.setText(administrador.getCpf());
                this.nome.setText(administrador.getNome());
                this.rg.setText(administrador.getRg());
                this.cidade.setText(administrador.getCidade());
                this.telefone.setText(administrador.getTelefone());
                this.dataNasc.setText(administrador.getDataNasc());
                this.email.setText(administrador.getEmail());
                this.bairro.setText(administrador.getBairro());
                this.rua.setText(administrador.getRua());
                this.numero.setText(administrador.getNumCasa());
            ...
            Logger.getLogger(TelaPesquisaAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        administrador.setCpf(this.cpf.getText());
        administrador.setNome(this.nome.getText());
        administrador.setRg(this.rg.getText());
        administrador.setDataNasc(this.dataNasc.getText());
        administrador.setTelefone(this.telefone.getText());
        administrador.setEmail(this.email.getText());
        administrador.setCidade(this.cidade.getText());
        administrador.setBairro(this.bairro.getText());
        administrador.setRua(this.rua.getText());
        administrador.setNumCasa(this.numero.getText());
        ...
        try {
            AdministradorService administradorService = new AdministradorService();
            administradorService.alterarAdministrador(administrador);
        } catch (SQLException ex) {
            Logger.getLogger(TelaPesquisaAdmin.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(TelaPesquisaAdmin.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ...
        String cpfAdmin = this.cpf.getText();

        JOptionPane.showMessageDialog(null, "Administrador Excluido com suceso!");
        this.dispose();
        new TelaAdmin().setVisible(true);

        try {
            AdministradorService administradorService = new AdministradorService();
            administradorService.deletarAdministrador(cpfAdmin);
            
            ContaUsuarioService contaUsuarioService = new ContaUsuarioService();
            contaUsuarioService.deletarContaUsuario(cpfAdmin);
