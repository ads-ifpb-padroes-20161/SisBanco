 ...
 * @author Joanderson
 */
public class TelaGerenteGeral extends javax.swing.JFrame {

    /**
     * Creates new form TelaGerenteGeral
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaGerenteGeral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
