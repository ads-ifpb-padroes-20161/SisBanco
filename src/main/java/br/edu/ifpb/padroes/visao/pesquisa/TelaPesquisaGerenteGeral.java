...
public class TelaPesquisaGerenteGeral extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("PESQUISAR - GERENTE GERAL");
    ...
    private void pesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_pesquisarActionPerformed
        ...
        try {
            ...
            GerenteGeralService gerenteGeralService = new GerenteGeralService();
            gerenteGeral = gerenteGeralService.pesquisarGerenteGeral(this.cpf.getText());

            if (gerenteGeral == null) {
                JOptionPane.showMessageDialog(null, "Nenhum gerente geral encontrado !");
            } else {
                this.cpf.setText(gerenteGeral.getCpf());
                this.nome.setText(gerenteGeral.getNome());
                this.rg.setText(gerenteGeral.getRg());
                this.cidade.setText(gerenteGeral.getCidade());
                this.telefone.setText(gerenteGeral.getTelefone());
                this.dataNasc.setText(gerenteGeral.getDataNasc());
                this.email.setText(gerenteGeral.getEmail());
                this.bairro.setText(gerenteGeral.getBairro());
                this.rua.setText(gerenteGeral.getRua());
                this.numero.setText(gerenteGeral.getNumCasa());
    ...
    private void salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_salvarActionPerformed
        ...
        gerenteGeral.setCpf(this.cpf.getText());
        gerenteGeral.setNome(this.nome.getText());
        gerenteGeral.setRg(this.rg.getText());
        gerenteGeral.setDataNasc(this.dataNasc.getText());
        gerenteGeral.setTelefone(this.telefone.getText());
        gerenteGeral.setEmail(this.email.getText());
        gerenteGeral.setCidade(this.cidade.getText());
        gerenteGeral.setBairro(this.bairro.getText());
        gerenteGeral.setRua(this.rua.getText());
        gerenteGeral.setNumCasa(this.numero.getText());

        JOptionPane.showMessageDialog(null, "Gerente geral alterado com sucesso!");
        this.dispose();
        new TelaAdmin().setVisible(true);

        try {
            GerenteGeralService gerenteGeralService = new GerenteGeralService();
            gerenteGeralService.alterarGerenteGeral(gerenteGeral);
        } catch (SQLException ex) {
            Logger.getLogger(TelaPesquisaGerenteGeral.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ...
        String cpfGerenteGeral = this.cpf.getText();

        JOptionPane.showMessageDialog(null, "Gerente geral Excluido com suceso!");
        this.dispose();
        new TelaAdmin().setVisible(true);

        try {
            GerenteGeralService gerenteGeralService = new GerenteGeralService();
            gerenteGeralService.deletarGerenteGeral(cpfGerenteGeral);

            ContaUsuarioService contaUsuarioService = new ContaUsuarioService();
            contaUsuarioService.deletarContaUsuario(cpfGerenteGeral);
