...
public class TelaSaldo extends javax.swing.JFrame {
    ...
    public TelaSaldo(ContaUsuario contaUsuario) throws SQLException {
        initComponents();
    ...
    private void pegarSaldo() throws SQLException{
        List<Conta> contas = clienteService.listarContasCliente(contaUsuario.getCpf());
        String saldo = String.valueOf(contas.get(0).getSaldo());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.dispose();
        new TelaCliente(this.contaUsuario).setVisible(true);
